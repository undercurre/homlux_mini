  ...
  return (function () {
  ...
  })()(
    {
          ...
          ;(function (r, n) {
            ...
            function y(e, t, r) {
              ...
              p('sendPacket :: writeToStream result %s', n),
                !n && r
                  ? (p('sendPacket :: handle events on `drain` once through callback.'), e.stream.once('drain', r))
                  : r && (p('sendPacket :: invoking cb'), r())
            }
            function _(e, t, r, n) {
              p('storeAndSend :: store packet with cmd %s to outgoingStore', t.cmd),
            ...
            function w(e, t) {
              ...
              p('MqttClient :: options.protocol', t.protocol),
                ...
                p('MqttClient :: options.rejectUnauthorized', t.rejectUnauthorized),
                (this.options.clientId =
                  'string' == typeof t.clientId ? t.clientId : 'mqttjs_' + Math.random().toString(16).substr(2, 8)),
            ...
            c(w, i),
              (w.prototype._setupStream = function () {
                ...
                if (
                  ...
                  p('_setupStream :: using streamBuilder provided to client to create stream'),
                  ...
                  this.stream.on('error', function (e) {
                    p('streamErrorHandler :: error', e.message),
                      b.includes(e.code) ? (p('streamErrorHandler :: emitting error'), t.emit('error', e)) : v(e)
                  }),
                  ...
                  if (!this.options.properties.authenticationMethod && this.options.properties.authenticationData)
                    return t.end(() => this.emit('error', new Error('Packet has no Authentication Method'))), this
                  if (
              ...
              (w.prototype._checkDisconnecting = function (e) {
                return (
                  this.disconnecting &&
                    (e ? e(new Error('client disconnecting')) : this.emit('error', new Error('client disconnecting'))),
                  this.disconnecting
                )
              }),
              (w.prototype.publish = function (e, t, r, n) {
                ...
                if (((r = f({ qos: 0, retain: !1, dup: !1 }, r)), this._checkDisconnecting(n))) return this
                switch (
                  ((i = {
                    cmd: 'publish',
                    topic: e,
                  ...
                  5 === o.protocolVersion &&
                    ...
                    ((!o.properties && i.properties && i.properties.topicAlias) ||
                      (r.properties &&
                        o.properties &&
                  ...
                  case 2:
                    ;(this.outgoing[i.messageId] = { volatile: !1, cb: n || v }),
                      this._storeProcessing
                        ...
                        : (p('MqttClient:publish: packet cmd: %s', i.cmd), this._sendPacket(i, void 0, r.cbStorePut))
                    break
                  default:
                    this._storeProcessing
                      ? (p('_storeProcessing enabled'), this._storePacket(i, n, r.cbStorePut))
                      : (p('MqttClient:publish: packet cmd: %s', i.cmd), this._sendPacket(i, n, r.cbStorePut))
                }
                return this
              }),
                  ...
                  Array.isArray(o)
                    ? o.forEach(function (e) {
                        if (
                          ...
                          5 === h && ((t.nl = c.nl), (t.rap = c.rap), (t.rh = c.rh), (t.properties = c.properties)),
                            p('subscribe: pushing topic `%s` and qos `%s` to subs list', t.topic, t.qos),
                            i.push(t)
                        }
                      })
                    : Object.keys(o).forEach(function (e) {
                        if (
                          ...
                          5 === h &&
                            ((t.nl = o[e].nl), (t.rap = o[e].rap), (t.rh = o[e].rh), (t.properties = c.properties)),
                            p('subscribe: pushing `%s` to subs list', t),
                            i.push(t)
                        }
                      }),
                  (e = { cmd: 'subscribe', subscriptions: i, qos: 1, retain: !1, dup: !1, messageId: this._nextId() }),
              ...
              (w.prototype.unsubscribe = function () {
                ...
                return (
                  ...
                  this._checkDisconnecting(o)
                    ? this
                    : ('string' == typeof i ? (e.unsubscriptions = [i]) : Array.isArray(i) && (e.unsubscriptions = i),
              ...
              (w.prototype.end = function (e, t, r) {
                var n = this
                function i() {
                  p('end :: (%s) :: finish :: calling _cleanUp with force %s', n.options.clientId, e),
                    n._cleanUp(
                      e,
                      () => {
                        p('end :: finish :: calling process.nextTick on closeStores'),
                          h(
                            function () {
                              p('end :: closeStores: closing incoming and outgoing stores'),
                                (n.disconnected = !0),
                ...
                return (
                  ...
                  (null != e && 'boolean' == typeof e) ||
                    ...
                    (t = e),
                    (e = !1),
                    'object' != typeof t && ((r = t), (t = null), 'function' != typeof r && (r = v))),
                  ...
                  this.disconnecting
                    ...
                    : (this._clearReconnect(),
                      ...
                      !e && Object.keys(this.outgoing).length > 0
                        ? (p('end :: (%s) :: calling finish in 10ms once outgoing is empty', n.options.clientId),
                          this.once('outgoingEmpty', setTimeout.bind(null, i, 10)))
                        : (p('end :: (%s) :: immediately calling finish', n.options.clientId), i()),
                      this)
                )
              }),
              ...
              (w.prototype.reconnect = function (e) {
                ...
                var t = this,
                  r = function () {
                    e
                      ? ((t.options.incomingStore = e.incomingStore), (t.options.outgoingStore = e.outgoingStore))
                      : ((t.options.incomingStore = null), (t.options.outgoingStore = null)),
              ...
              (w.prototype._setupReconnect = function () {
                ...
                !e.disconnecting && !e.reconnectTimer && e.options.reconnectPeriod > 0
                  ? (this.reconnecting ||
                      ...
                      (this.reconnecting = !0)),
                    p('_setupReconnect :: setting reconnectTimer for %d ms', e.options.reconnectPeriod),
              ...
              (w.prototype._cleanUp = function (e, t) {
                var r,
                  n = arguments[2]
                if (
                  (t && (p('_cleanUp :: done callback provided for on stream close'), this.stream.on('close', t)),
                  ...
                  p('_cleanUp :: (%s) :: call _sendPacket with disconnect packet', this.options.clientId),
                    this._sendPacket(i, d.bind(null, this.stream.end.bind(this.stream)))
                }
                this.disconnecting ||
                  (p('_cleanUp :: client not disconnecting. Clearing and resetting reconnect.'),
                  this._clearReconnect(),
                  this._setupReconnect()),
                  null !== this.pingTimer &&
                    (p('_cleanUp :: clearing pingTimer'), this.pingTimer.clear(), (this.pingTimer = null)),
                  t &&
                    !this.connected &&
                    (p('_cleanUp :: (%s) :: removing stream `done` callback `close` listener', this.options.clientId),
                    this.stream.removeListener('close', t),
                    t())
              }),
              (w.prototype._sendPacket = function (e, t, r) {
                if ((p('_sendPacket :: (%s) ::  start', this.options.clientId), (r = r || v), !this.connected))
                  return (
                    p('_sendPacket :: client not connected. Storing packet offline.'), void this._storePacket(e, t, r)
                  )
              ...
              (w.prototype._storePacket = function (e, t, r) {
                p('_storePacket :: packet: %o', e),
                  ...
                  (r = r || v),
                  (0 === (e.qos || 0) && this.queueQoSZero) || 'publish' !== e.cmd
                    ? this.queue.push({ packet: e, cb: t })
                    : e.qos > 0
                    ? ((t = this.outgoing[e.messageId] ? this.outgoing[e.messageId].cb : null),
              ...
              (w.prototype._checkPing = function () {
                p('_checkPing :: checking ping...'),
                  this.pingResp
                    ? (p('_checkPing :: ping response received. Clearing flag and sending `pingreq`'),
                      (this.pingResp = !1),
                ...
                if (
                  ...
                  e.properties &&
                    ...
                    e.properties.serverKeepAlive &&
                      t.keepalive &&
                      ((t.keepalive = e.properties.serverKeepAlive), this._shiftPingInterval()),
              ...
              (w.prototype._handleAck = function (e) {
                ...
                if (o) {
                  switch ((p('_handleAck :: packet type', n), n)) {
                    ...
                    case 'puback':
                      var a = e.reasonCode
                      a && a > 0 && 16 !== a && (((t = new Error('Publish error: ' + m[a])).code = a), o(t, e)),
                    ...
                    case 'pubrec':
                      ...
                      var c = e.reasonCode
                      c && c > 0 && 16 !== c
                        ? (((t = new Error('Publish error: ' + m[c])).code = c), o(t, e))
                        : this._sendPacket(i)
                      break
                    case 'suback':
                      delete this.outgoing[r]
              ...
              (w.prototype._resubscribe = function (e) {
                ...
                if (
                  ...
                  (this.options.clean || (5 === this.options.protocolVersion && !e.sessionPresent)) &&
                  t.length > 0
                )
                  if (this.options.resubscribe)
                          ...
                          if (n) {
                            ...
                            i
                              ? t._packetIdsDuringStoreProcessing[i.messageId]
                                ...
                                ? n.destroy && n.destroy()
                                : ((r = t.outgoing[i.messageId] ? t.outgoing[i.messageId].cb : null),
          ...
          ;(function (r) {
            ...
            t.exports = function (e, t) {
              ...
              var f = (function (e, t) {
                ...
                return (
                  e.port && 80 !== e.port && 443 !== e.port && (n = r + '://' + e.hostname + ':' + e.port + e.path),
      ...
      5: [
            ...
            t.exports = l
              ? function (e, t) {
                  ...
                  function v(e, t) {
                    ...
                    for (let t = 0; t < e.length; t++)
                      'string' == typeof e[t].chunk ? (r[t] = s.from(e[t], 'utf8')) : (r[t] = e[t].chunk)
              ...
              : function (e, t) {
                  ...
                  let s = (function (e, t, r) {
                      ...
                      return (
                        i('creating new Websocket for url: ' + t + ' and protocol: ' + o), new n(t, [o], r.wsOptions)
                      )
                    })(0, o, r),
        ...
        { _process: 101, debug: 17, duplexify: 19, 'readable-stream': 115, 'safe-buffer': 117, url: 132, ws: 139 },
      ],
      6: [
        function (e, t, r) {
          ;(function (r) {
          ...
          ;(function (r) {
            ...
            ;(void 0 !== r && 'browser' !== r.title) || 'function' == typeof __webpack_require__
              ? ((c.mqtt = e('./tcp')),
                ...
                (c.tls = e('./tls')),
                (c.mqtts = e('./tls')))
              : ((c.wx = e('./wx')), (c.wxs = e('./wx')), (c.ali = e('./ali')), (c.alis = e('./ali'))),
              (c.ws = e('./ws')),
              (c.wss = e('./ws')),
              (t.exports = u),
              (t.exports.connect = u),
        ...
        function (e, t, r) {
          ...
          i.inherits(s, n),
            ...
            (s.prototype.append = function (e) {
              ...
              else if (e instanceof s) for (; t < e._bufs.length; t++) this.append(e._bufs[t])
            ...
            (s.prototype.copy = function (e, t, r, n) {
              ...
              if (l <= this._bufs[c[0]].length - p)
                return a ? this._bufs[c[0]].copy(e, t, p, p + l) : this._bufs[c[0]].slice(p, p + l)
            ...
            (s.prototype.shallowSlice = function (e, t) {
              ...
              return (
                0 == n[1] ? i.pop() : (i[i.length - 1] = i[i.length - 1].slice(0, n[1])),
          ...
          ;(function (t) {
            ...
            ;(r.kMaxLength = o),
              ...
              (t.alloc = function (e, t, r) {
                return (function (e, t, r) {
                  return (
                    c(e), e <= 0 ? s(e) : void 0 !== t ? ('string' == typeof r ? s(e).fill(t, r) : s(e).fill(t)) : s(e)
                  )
                })(e, t, r)
              }),
              ...
              (t.prototype.compare = function (e, r, n, i, o) {
                ...
                for (
                  var s = o - i, a = n - r, c = Math.min(s, a), u = this.slice(i, o), l = e.slice(r, n), f = 0;
                  f < c;
                  ++f
                )
                  if (u[f] !== l[f]) {
            ...
            ;(t.prototype.slice = function (e, r) {
              ...
              (t.prototype.copy = function (e, r, n, i) {
                ...
                else if (this === e && n < r && r < i) for (var s = o - 1; s >= 0; --s) e[s + r] = this[s + n]
            ...
            return (
              ...
              (n.get = function () {
                return !r.overwriteDefinition && p.call(this, e)
                  ? i
                  : ((t.value = l.call(i, r.resolveContext ? r.resolveContext(this) : this)), f(this, e, t), this[e])
              }),
              n
            )
          }),
        ...
        function (e, t, r) {
          ...
          ;(t.exports = function (e, t) {
            ...
            return (
              ...
              n(e) ? ((r = a.call(e, 'c')), (i = a.call(e, 'e')), (c = a.call(e, 'w'))) : ((r = c = !0), (i = !1)),
            ...
            var c, u, l, f
            return (
              'string' != typeof e ? ((l = r), (r = t), (t = e), (e = null)) : (l = arguments[3]),
              n(t)
                ? i(t)
                  ? n(r)
                    ? i(r) || ((l = r), (r = void 0))
                  ...
                  : ((l = t), (t = r = void 0))
                : (t = void 0),
              n(e) ? ((c = a.call(e, 'c')), (u = a.call(e, 'e'))) : ((c = !0), (u = !1)),
      ...
      19: [
            ...
            s(f, i.Duplex),
              ...
              (f.prototype.setWritable = function (e) {
                if ((this._unwrite && this._unwrite(), this.destroyed)) e && e.destroy && e.destroy()
                  ...
                  var t = this,
                    n = o(e, { writable: !0, readable: !1 }, l(this, this._forwardEnd)),
                    i = function () {
                      var e = t._ondrain
                      ;(t._ondrain = null), e && e()
                    }
                ...
                if ((this._unread && this._unread(), this.destroyed)) e && e.destroy && e.destroy()
                  ...
                  ;(this._drained = !0),
                    ...
                    (this._readable2 = e._readableState
                      ? e
                      : ((t = e), new i.Readable({ objectMode: !0, highWaterMark: 16 }).wrap(t))),
              ...
              (f.prototype._write = function (e, t, r) {
                return this.destroyed
                  ...
                  ? this._finish(r)
                  : this._writable
                  ? void (!1 === this._writable.write(e) ? (this._ondrain = r) : r())
                  : r()
              }),
        ...
        { _process: 101, buffer: 13, 'end-of-stream': 20, inherits: 88, 'readable-stream': 115, 'stream-shift': 118 },
      ],
      20: [
        function (e, t, r) {
          ;(function (r) {
            var n = e('once'),
              ...
              o = function (e, t, s) {
                ...
                var a = e._writableState,
                  ...
                  y = function () {
                    if (!f)
                      return (!u || (c && c.ended && !c.destroyed)) && (!l || (a && a.ended && !a.destroyed))
                        ? void 0
                ...
                return (
                  !(function (e) {
                    ...
                    : (e.on('complete', h), e.on('abort', m), e.req ? _() : e.on('request', _)),
                  (function (e) {
      ...
      22: [
        function (e, t, r) {
          ...
          t.exports = function (e) {
            ...
            for (
              r = i(o(this).length), l = arguments[1], t = l = isNaN(l) ? 0 : l >= 0 ? u(l) : i(this.length) - u(c(l));
              t < r;
              ++t
            )
          ...
          t.exports = function (e) {
            ...
            if (!f(e))
              if (void 0 !== (w = e[n])) {
                ...
                for (m = e.length, t && (b = new t()), r = 0, g = 0; r < m; ++r)
                  (S = e[r]),
                    r + 1 < m && (y = S.charCodeAt(0)) >= 55296 && y <= 56319 && (S += e[++r]),
            ...
            if (void 0 === m)
              for (m = s(e.length), t && (b = new t(m)), r = 0; r < m; ++r)
                (S = k ? p.call(k, x, e[r], r) : e[r]), t ? ((h.value = S), d(b, r, h)) : (b[r] = S)
              ...
              ? 1 !== n.level
                ...
                : ((i = {}),
                  ...
                  Object.getOwnPropertyNames(Object.prototype).forEach(function (e) {
                    o[e] = '__proto__' !== e ? s : { configurable: !0, enumerable: !1, writable: !0, value: void 0 }
                  }),
            ...
            (t.exports = (i = (function () {
              ...
              return (
                ...
                Object.getPrototypeOf(t) === r
                  ? { level: 2 }
                  : (((t = {}).__proto__ = r), Object.getPrototypeOf(t) === r && { level: 1 })
              )
            })())
              ? (2 === i.level
                  ? i.set
                  ...
                  : (o = function e(t, r) {
                      ...
                      return (
                        n(t, r),
                        (i = u.call(e.nullPolyfill, t)) && delete e.nullPolyfill.__proto__,
      ...
      61: [
        function (e, t, r) {
          ...
          ;(n = t.exports =
            function (e, t) {
              ...
              c.call(this, e),
                (t = t ? (o.call(t, 'key+value') ? 'key+value' : o.call(t, 'key') ? 'key' : 'value') : 'value'),
                u(this, '__kind__', s('', t))
            }),
            i && i(n, c),
        ...
        { './': 64, d: 16, 'es5-ext/object/set-prototype-of': 52, 'es5-ext/string/#/contains': 57, 'es6-symbol': 74 },
      ],
      62: [
        function (e, t, r) {
          'use strict'
          ...
          t.exports = function (e, t) {
            var r,
              ...
              m = arguments[2]
            if (
              (a(e) || n(e) ? (r = 'array') : o(e) ? (r = 'string') : (e = s(e)),
              i(t),
              (f = function () {
                p = !0
              }),
              ...
              if ('string' !== r)
                ...
                for (
                  ...
                  h < d &&
                  ((g = e[h]),
                  h + 1 < d && (b = g.charCodeAt(0)) >= 55296 && b <= 56319 && (g += e[++h]),
                  c.call(t, m, g, f),
                  !p);
                  ++h
                );
      ...
      64: [
        function (e, t, r) {
          ...
          ;(t.exports = n =
            function (e, t) {
              if (!(this instanceof n)) throw new TypeError("Constructor requires 'new'")
              p(this, { __list__: c('w', a(e)), __context__: c('w', t), __nextIndex__: c('w', 0) }),
                t &&
                  (s(t.on), t.on('_add', this._onAdd), t.on('_delete', this._onDelete), t.on('_clear', this._onClear))
            }),
            delete n.prototype.constructor,
            p(
              n.prototype,
                ...
                u({
                  ...
                  _onDelete: c(function (e) {
                    ...
                    e >= this.__nextIndex__ ||
                      (--this.__nextIndex__,
                      this.__redo__ &&
                        (-1 !== (t = this.__redo__.indexOf(e)) && this.__redo__.splice(t, 1),
                        this.__redo__.forEach(function (t, r) {
                          t > e && (this.__redo__[r] = --t)
                        }, this)))
                  }),
      ...
      72: [
          ...
          ;(n = t.exports =
            function (e, t) {
              ...
              s.call(this, e.__mapKeysData__, e),
                (t && c[t]) || (t = 'key+value'),
                u(this, { __kind__: o('', t), __values__: o('w', e.__mapValuesData__) })
            }),
            i && i(n, s),
        ...
        { './iterator-kinds': 71, d: 16, 'es5-ext/object/set-prototype-of': 52, 'es6-iterator': 64, 'es6-symbol': 74 },
      ],
      73: [
        function (e, t, r) {
          'use strict'
          ...
          ;(t.exports = n =
            function () {
              ...
              return (
                ...
                null != i && p(i),
                m(r, { __mapKeysData__: u('c', (e = [])), __mapValuesData__: u('c', (t = [])) }),
                i
                  ? (h(
                      i,
                      function (r) {
            ...
            g && (s && s(n, Map), (n.prototype = Object.create(Map.prototype, { constructor: u(n) }))),
            l(
              m(n.prototype, {
                clear: u(function () {
                  this.__mapKeysData__.length &&
                    (i.call(this.__mapKeysData__), i.call(this.__mapValuesData__), this.emit('_clear'))
                }),
                delete: u(function (e) {
                ...
                forEach: u(function (e) {
                  ...
                  for (a(e), r = (t = this.entries())._next(); void 0 !== r; )
                    b.call(e, n, this.__mapValuesData__[r], this.__mapKeysData__[r], this), (r = t._next())
                }),
                get: u(function (e) {
                  var t = o.call(this.__mapKeysData__, e)
                ...
                set: u(function (e, t) {
                  ...
                  return (
                    -1 === n && ((n = this.__mapKeysData__.push(e) - 1), (r = !0)),
          ...
          ;(a = {
            on: (n = function (e, t) {
              ...
              return (
                ...
                m.call(this, '__ee__')
                  ? (r = this.__ee__)
                  : ((r = y.value = d(null)), g(this, '__ee__', y), (y.value = null)),
      ...
      83: [
        function (e, t, r) {
          ...
          function f(e, t, r, i) {
            ...
            if (
              ((s = e._events)
                ? (s.newListener && (e.emit('newListener', t, r.listener ? r.listener : r), (s = e._events)),
                  (a = s[t]))
                : ((s = e._events = n(null)), (e._eventsCount = 0)),
              a)
            ) {
              if (
                ('function' == typeof a ? (a = s[t] = i ? [r, a] : [a, r]) : i ? a.unshift(r) : a.push(r),
          ...
          a
            ...
            (s.prototype.emit = function (e) {
              ...
              switch ((n = arguments.length)) {
                case 1:
                  !(function (e, t, r) {
                    if (t) e.call(r)
                    else for (var n = e.length, i = b(e, n), o = 0; o < n; ++o) i[o].call(r)
                  })(r, u, this)
                  break
                case 2:
                  !(function (e, t, r, n) {
                    if (t) e.call(r, n)
                    else for (var i = e.length, o = b(e, i), s = 0; s < i; ++s) o[s].call(r, n)
                  })(r, u, this, arguments[1])
                  break
                case 3:
                  !(function (e, t, r, n, i) {
                    if (t) e.call(r, n, i)
                    else for (var o = e.length, s = b(e, o), a = 0; a < o; ++a) s[a].call(r, n, i)
                  })(r, u, this, arguments[1], arguments[2])
                  break
                case 4:
                  !(function (e, t, r, n, i, o) {
                    if (t) e.call(r, n, i, o)
                    else for (var s = e.length, a = b(e, s), c = 0; c < s; ++c) a[c].call(r, n, i, o)
                ...
                default:
                  ...
                  !(function (e, t, r, n) {
                    if (t) e.apply(r, n)
                    else for (var i = e.length, o = b(e, i), s = 0; s < i; ++s) o[s].apply(r, n)
                  })(r, u, this, i)
              }
              return !0
            }),
            ...
            (s.prototype.removeAllListeners = function (e) {
              ...
              if (0 === arguments.length) {
                ...
                return (
                  this.removeAllListeners('removeListener'), (this._events = n(null)), (this._eventsCount = 0), this
                )
              }
                ...
                t = Math.abs(t),
                  isNaN(t) || t === 1 / 0
                    ...
                    : ((s = Math.floor(Math.log(t) / Math.LN2)),
                      ...
                      (t += s + f >= 1 ? p / c : p * Math.pow(2, 1 - f)) * c >= 2 && (s++, (c /= 2)),
                      s + f >= l
                        ? ((a = 0), (s = l))
                        : s + f >= 1
            ...
            return [0, 1, 2].map(function (t) {
              return [0, 1].map(function (r) {
                return [0, 1].map(function (o) {
                  var s = n.alloc(1)
                  return (
                    s.writeUInt8((i.codes[e] << i.CMD_SHIFT) | (r ? i.DUP_MASK : 0) | (t << i.QOS_SHIFT) | o, 0, !0), s
                  )
                })
              })
            })
          ...
          e('inherits')(s, o),
            ...
            (s.prototype.concat = function () {
              ...
              for (e = 0; e < o.length && void 0 !== o[e]; e++)
                'string' != typeof o[e] ? (i[e] = o[e].length) : (i[e] = n.byteLength(o[e])), (r += i[e])
              for (t = n.allocUnsafe(r), e = 0; e < o.length && void 0 !== o[e]; e++)
                'string' != typeof o[e] ? (o[e].copy(t, s), (s += i[e])) : (t.write(o[e], s), (s += i[e]))
              return t
            }),
            (t.exports = function (e, t) {
              var r = new s()
        ...
        function (e, t, r) {
          ...
          i(u, o),
            (u.prototype._resetState = function () {
              c('_resetState: resetting packet, error, _list, and _stateCounter'),
                (this.packet = new s()),
                (this.error = null),
                (this._list = n()),
            ...
            (u.prototype.parse = function (e) {
              for (
                this.error && this._resetState(),
                  this._list.append(e),
                  c('parse: current state: %s', this._states[this._stateCounter]);
                ...
                this._stateCounter++,
                  c('parse: state complete. _stateCounter is now: %d', this._stateCounter),
                  c('parse: packet.length: %d, buffer list length: %d', this.packet.length, this._list.length),
            ...
            (u.prototype._parseLength = function () {
              ...
              return (
                e && ((this.packet.length = e.value), this._list.consume(e.bytes)), c('_parseLength %d', e.value), !!e
              )
            }),
            ...
            (u.prototype._parseConnect = function () {
              ...
              if (
                ...
                3 !== u.protocolVersion && 4 !== u.protocolVersion && 5 !== u.protocolVersion)
              )
                return this._emitError(new Error('Invalid protocol version'))
              if ((this._pos++, this._pos >= this._list.length)) return this._emitError(new Error('Packet too short'))
              if (
                ((s.username = this._list.readUInt8(this._pos) & a.USERNAME_MASK),
                (s.password = this._list.readUInt8(this._pos) & a.PASSWORD_MASK),
                (s.will = this._list.readUInt8(this._pos) & a.WILL_FLAG_MASK),
                s.will &&
                  ((u.will = {}),
                  (u.will.retain = 0 != (this._list.readUInt8(this._pos) & a.WILL_RETAIN_MASK)),
                  (u.will.qos = (this._list.readUInt8(this._pos) & a.WILL_QOS_MASK) >> a.WILL_QOS_SHIFT)),
            ...
            (u.prototype._parseConnack = function () {
              ...
              if (
                ((e.sessionPresent = !!(this._list.readUInt8(this._pos++) & a.SESSIONPRESENT_MASK)),
              ...
              if (((u.subscriptions = []), this._parseMessageId())) {
                ...
                for (; this._pos < u.length; ) {
                  ...
                  ;(r = (t = this._parseByte()) & a.SUBSCRIBE_OPTIONS_QOS_MASK),
                    (o = 0 != ((t >> a.SUBSCRIBE_OPTIONS_NL_SHIFT) & a.SUBSCRIBE_OPTIONS_NL_MASK)),
                    (i = 0 != ((t >> a.SUBSCRIBE_OPTIONS_RAP_SHIFT) & a.SUBSCRIBE_OPTIONS_RAP_MASK)),
                    (n = (t >> a.SUBSCRIBE_OPTIONS_RH_SHIFT) & a.SUBSCRIBE_OPTIONS_RH_MASK),
                    (s = { topic: e, qos: r }),
                    5 === this.settings.protocolVersion && ((s.nl = o), (s.rap = i), (s.rh = n)),
                    c('_parseSubscribe: push subscription `%s` to subscription', s),
            ...
            (u.prototype._parseUnsuback = function () {
              ...
              if (5 === this.settings.protocolVersion) {
                var t = this._parseProperties()
                for (
                  Object.getOwnPropertyNames(t).length && (e.properties = t), e.granted = [];
            ...
            (u.prototype._parseConfirmation = function () {
              ...
              if (
                ...
                5 === this.settings.protocolVersion &&
                  (e.length > 2 &&
                    ((e.reasonCode = this._parseByte()), c('_parseConfirmation: packet.reasonCode `%d`', e.reasonCode)),
                  e.length > 3))
              ) {
                var t = this._parseProperties()
                Object.getOwnPropertyNames(t).length && (e.properties = t)
            ...
            (u.prototype._parseStringPair = function () {
              return c('_parseStringPair'), { name: this._parseString(), value: this._parseString() }
            }),
            (u.prototype._parseBuffer = function () {
              ...
              return -1 === t || r > this._list.length || r > this.packet.length
                ? null
                : ((e = this._list.slice(this._pos, r)), (this._pos += t), c('_parseBuffer: result: %o', e), e)
            }),
            ...
            (u.prototype._parseVarByteNum = function (e) {
              c('_parseVarByteNum')
              for (
                var t, r = 0, n = 1, i = 0, o = !0, s = this._pos ? this._pos : 0;
                r < 5 &&
                ((i += n * ((t = this._list.readUInt8(s + r++)) & a.LENGTH_MASK)),
                (n *= 128),
              ...
              return (
                s && (this._pos += r),
                c('_parseVarByteNum: result: %o', (o = !!o && (e ? { bytes: r, value: i } : i))),
                o
              )
            }),
                ...
                if ('userProperties' !== i)
                  r[i]
                    ? Array.isArray(r[i])
                      ...
                      : ((r[i] = [r[i]]), r[i].push(this._parseByType(a.propertiesTypes[i])))
      ...
      97: [
              ...
              case 'connect':
                return (function (e, t, r) {
                  ...
                  t.write(n.CONNECT_HEADER),
                    v(t, b),
                    E(t, s),
                    t.write(4 === a ? n.VERSION4 : 5 === a ? n.VERSION5 : n.VERSION3)
                  var S = 0
              ...
              switch (n.propertiesTypes[t]) {
                ...
                case 'int8':
                  if ('number' != typeof r || r < 0 || r > 255)
                    return e.emit('error', new Error('Invalid ' + t + ': ' + r)), !1
                  o += 2
                  break
                case 'binary':
                  ...
                  o += Object.getOwnPropertyNames(r).reduce(function (e, t) {
                    ...
                    return (
                      Array.isArray(n)
                        ...
                        : (e += 3 + i.byteLength(t.toString()) + 2 + i.byteLength(r[t].toString())),
                      e
                    )
                  }, 0)
                  break
          ...
          function j(e, t, r) {
            for (var n in (v(e, r), t))
              if (t.hasOwnProperty(n) && null !== t[n]) {
                var i = t[n]
                if (Array.isArray(i)) for (var o = 0; o < i.length; o++) O(e, n, i[o])
                else O(e, n, i)
              }
          }
          function A(e) {
        ...
        { './constants': 91, './numbers': 94, debug: 17, 'process-nextick-args': 100, 'safe-buffer': 117 },
      ],
      98: [
        function (e, t, r) {
          var n = 1e3,
            ...
            !(function (n) {
              ...
              function C(e, t) {
                var r = e.split('@'),
                  n = ''
                return (
                  r.length > 1 && ((n = r[0] + '@'), (e = r[1])), n + I((e = e.replace(v, '.')).split('.'), t).join('.')
                )
              }
              function O(e) {
              ...
              function j(e) {
                return I(e, function (e) {
                  var t = ''
                  return (
                    e > 65535 && ((t += x((((e -= 65536) >>> 10) & 1023) | 55296)), (e = 56320 | (1023 & e))),
                    (t += x(e))
                  )
                }).join('')
              }
              ...
              function P(e) {
                ...
                for ((r = e.lastIndexOf(m)) < 0 && (r = 0), n = 0; n < r; ++n)
                  e.charCodeAt(n) >= 128 && E('not-basic'), _.push(e.charCodeAt(n))
                for (i = r > 0 ? r + 1 : 0; i < v; ) {
                  for (
                    o = w, s = 1, a = l;
                    i >= v && E('invalid-input'),
                      ((c =
                        (y = e.charCodeAt(i++)) - 48 < 10 ? y - 22 : y - 65 < 26 ? y - 65 : y - 97 < 26 ? y - 97 : l) >=
                        l ||
                        c > k((u - w) / s)) &&
                        E('overflow'),
                      (w += c * s),
                ...
                for (n = i = I.length, i && I.push(m); n < _; ) {
                  ...
                  for (a - t > k((u - r) / (v = n + 1)) && E('overflow'), r += (a - t) * v, t = a, s = 0; s < _; ++s)
                    if (((y = e[s]) < t && ++r > u && E('overflow'), y == t)) {
                      for (c = r, h = l; !(c < (d = h <= o ? f : h >= o + p ? p : h - o)); h += l)
                        (S = c - d), (w = l - d), I.push(x(A(d + (S % w), 0))), (c = k(S / w))
          ...
          t.exports = function (e, t, r, o) {
            ...
            for (var l = 0; l < u; ++l) {
              var f,
                ...
                g = e[l].replace(a, '%20'),
                b = g.indexOf(r)
              b >= 0 ? ((f = g.substr(0, b)), (p = g.substr(b + 1))) : ((f = g), (p = '')),
                (h = decodeURIComponent(f)),
                (d = decodeURIComponent(p)),
                n(s, h) ? (i(s[h]) ? s[h].push(d) : (s[h] = [s[h], d])) : (s[h] = d)
            }
            return s
          }
          var i =
        ...
        function (e, t, r) {
          ;(function (r, n) {
                  ...
                  o
                    ...
                    ? ('string' == typeof t ||
                      ...
                      n
                        ...
                        : ((s.reading = !1),
                          s.decoder && !r
                            ? ((t = s.decoder.write(t)), s.objectMode || 0 !== t.length ? w(e, s, t, !1) : I(e, s))
                            : w(e, s, t, !1)))
                    : n || (s.reading = !1))
              return (function (e) {
            ...
            function x(e) {
              ...
              ;(t.needReadable = !1),
                t.emittedReadable ||
                  (h('emitReadable', t.flowing), (t.emittedReadable = !0), t.sync ? i.nextTick(E, e) : E(e))
            }
            function E(e) {
            ...
            ;(_.prototype.read = function (e) {
              ...
              if (
                ...
                return h('read: emitReadable', t.length, t.ended), 0 === t.length && t.ended ? P(this) : x(this), null
              ...
              return (
                ...
                t.ended || t.reading
                  ...
                  : i &&
                    ...
                    (t.sync = !1),
                    t.reading || (e = k(r, t))),
                null === (n = e > 0 ? T(e, t) : null) ? ((t.needReadable = !0), (e = 0)) : (t.length -= e),
              ...
              (_.prototype.pipe = function (e, t) {
                ...
                function g(t) {
                  h('ondata'),
                    ...
                    !1 !== e.write(t) ||
                      d ||
                      (((1 === o.pipesCount && o.pipes === e) || (o.pipesCount > 1 && -1 !== B(o.pipes, e))) &&
                        !p &&
      ...
      111: [
        function (e, t, r) {
          ;(function (r, n, i) {
            ...
            t.exports = y
            var a,
              c = !r.browser && ['v0.10', 'v0.9.'].indexOf(r.version.slice(0, 5)) > -1 ? i : o.nextTick
            y.WritableState = m
                        ...
                        --t.pendingcb,
                          r
                            ? (o.nextTick(i, n),
                              ...
                              e.emit('error', n))
                            : (i(n), (e._writableState.errorEmitted = !0), e.emit('error', n), x(e, t))
                      })(e, r, n, t, i)
                    else {
                      var s = S(r)
                      s || r.corked || r.bufferProcessing || !r.bufferedRequest || w(e, r),
          ...
          t.exports = function (e) {
            ...
            return t
              ? t.objectMode || 'number' == typeof e._duplexState
                ...
                : e.read(
                    ((r = t),
                    r.buffer.length ? (r.buffer.head ? r.buffer.head.data.length : r.buffer[0].length) : r.length),
                  )
              : null
            var r
          }
        ...
        function (e, t, r) {
          ...
          ;(o.prototype.parse = function (e, t, r) {
            ...
            if (((_ = _.trim()), !r && 1 === e.split('#').length)) {
              ...
              if (v)
                return (
                  ...
                  (this.pathname = v[1]),
                  v[2]
                    ? ((this.search = v[2]), (this.query = t ? y.parse(this.search.substr(1)) : this.search.substr(1)))
            ...
            if (!b[w] && (k || (w && !m[w]))) {
              ...
              ;-1 !== (E = -1 === I ? _.lastIndexOf('@') : _.lastIndexOf('@', I)) &&
                ((x = _.slice(0, E)), (_ = _.slice(E + 1)), (this.auth = decodeURIComponent(x))),
                (I = -1)
              ...
              ;(this.host = F + q),
                (this.href += this.host),
                j &&
                  ((this.hostname = this.hostname.substr(1, this.hostname.length - 2)), '/' !== _[0] && (_ = '/' + _))
            }
            if (!g[S])
            ...
            (o.prototype.resolveObject = function (e) {
              ...
              for (
                var E = k.slice(-1)[0],
                  I = ((r.host || e.host || k.length > 1) && ('.' === E || '..' === E)) || '' === E,
                  C = 0,
                  O = k.length;
                O >= 0;
                O--
              )
                '.' === (E = k[O]) ? k.splice(O, 1) : '..' === E ? (k.splice(O, 1), C++) : C && (k.splice(O, 1), C--)
              ...
              return (
                ...
                k.length ? (r.pathname = k.join('/')) : ((r.pathname = null), (r.path = null)),
                (i.isNull(r.pathname) && i.isNull(r.search)) ||
                  (r.path = (r.pathname ? r.pathname : '') + (r.search ? r.search : '')),
          ...
          ;(function (t, n) {
            ...
            function l(e, t, n) {
              ...
              if (
                ...
                S(t) && (s.indexOf('message') >= 0 || s.indexOf('description') >= 0))
              )
                return f(t)
              if (0 === s.length) {
                if (k(t)) {
                      ...
                      (u = x
                        ? (function (e, t, r, n, i) {
                            for (var o = [], s = 0, a = t.length; s < a; ++s)
                              C(t, String(s)) ? o.push(p(e, t, r, n, String(s), !0)) : o.push('')
                            return (
