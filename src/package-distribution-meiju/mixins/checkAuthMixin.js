...
const app = getApp()
const bluetooth = require('../mixins/bluetooth.js')

import { ab2hex } from 'm-utilsdk/index'
import { getScanRespPackInfo, getDeviceCategoryAndSn8 } from '../common/blueAdDataParse'
import { openAdapter } from '../common/blueApi'
import { bleRssiValue } from '../common/BleRssiValue'
