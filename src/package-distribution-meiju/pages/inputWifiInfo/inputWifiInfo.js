...
const app = getApp()
const addDeviceMixin = require('../../mixins/addDeviceMixin')
...
import { environment, api, imgBaseUrl } from '../../../../api'
...
Page({
  ...
  async configNetWork() {
    ...
    burialPoint.clickNext({
      ...
      linkType: app.addDeviceInfo.linkType,
      widgetName: '下一步',
      widgetId: mode == 31 ? 'click_connect_device' : 'click_next',
    })
    // wx.navigateTo({
